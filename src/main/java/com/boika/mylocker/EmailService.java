...
public class EmailService {
    ...
    @Async
    public void sendRequestReceived(String toEmail, String displayName) {

        String html = wrap(
                "We received your request",
                "Dear " + displayName + ",",
                "<p style=\"margin:0 0 14px;font-size:15px;line-height:1.6;color:#3A3A3A;\">"
                        + "Thank you for requesting access to HopeConnect. "
                        + "Your request has been passed to the administrator for review.</p>"
                        + "<p style=\"margin:0 0 14px;font-size:15px;line-height:1.6;color:#3A3A3A;\">"
                        + "If it is approved you will receive a second email with a link "
        ...
        String plain = "Dear " + displayName + ",\n\n"
                + "Thank you for requesting access to HopeConnect.\n"
                + "Your request has been passed to the administrator for review.\n\n"
                + "If approved you will receive a second email with a link to set your password.\n";

        send(toEmail, "HopeConnect: we received your request", html, plain);
    }
    ...
    public void sendInvite(String toEmail, String displayName, String token) {
        ...
        String html = wrap(
                ...
                "Dear " + displayName + ",",
                "<p style=\"margin:0 0 14px;font-size:15px;line-height:1.6;color:#3A3A3A;\">"
                        + "Your request for access to HopeConnect has been approved by the "
                        + "administrator. An account has been created for you. "
        ...
        String plain = "Dear " + displayName + ",\n\n"
                + "Your request for access to HopeConnect has been approved by the administrator.\n"
                + "An account has been created for you.\n\n"
                + "Set your password here:\n" + url + "\n\n"
                + "You will sign in with " + toEmail + "\n"
                + "This link expires in 30 minutes.\n";

        send(toEmail, "HopeConnect: your access request has been approved", html, plain);
    }
